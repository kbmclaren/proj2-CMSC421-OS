...
asmlinkage long sys_send_msg_421(unsigned long id, 
				const unsigned char __user *msg, long n);
asmlinkage long sys_recv_msg_421(unsigned long id, unsigned char __user *msg, 
				long n); 
asmlinkage long sys_peek_msg_421(unsigned long id, unsigned char __user *msg,
				long n);
